...
.page-sidebar .nav-pills li > a { padding: 13px 20px; border-radius: 4px; }
...
h1, h2, h3, h4, h5, h6, .h1, .h2, .h3, .h4, .h5, .h6 { font-weight: 600; margin: .5em 0; }
...
h1.section-title, h2.section-title, h3.section-title, h4.section-title, h5.section-title, h6.section-title, .h1.section-title, .h2.section-title, .h3.section-title, .h4.section-title, .h5.section-title, .h6.section-title { color: #555; font-weight: 600; text-transform: uppercase; margin-bottom: 24px; }
...
@media (min-width: 992px) { .jumbotron li { font-size: 14px; }
  ...
  h2, .h2 { font-size: 2.285714em; }
  h3, .h3 { font-size: 2em; }
  h4, .h4 { font-size: 1.714285em; }
  h5, .h5 { font-size: 1.3em; }
  h6, .h6 { font-size: 1em; } }
.btn-primary { background-color: #0072bb; }
...
.btn { border: 3px solid transparent; font-size: 16px; font-weight: 600; margin-bottom: 10px; padding: 8px 20px; text-transform: inherit; vertical-align: top; white-space: normal; word-break: initial; text-decoration: none; letter-spacing: inherit; border-radius: 30px; }
...
header .btn { margin: 13px 0 0 13px; padding-left: 15px; padding-right: 15px; }
...
.navbar-default { position: relative; background-color: #fff; border: 0; border-top-left-radius: 0; border-top-right-radius: 0; box-shadow: none; border-bottom: solid 1px #DDD; margin: 0; z-index: 9; }
...
.navbar-form .form-control { border: solid 1px #DDD; border-right: 0; color: #333333; font-size: 16px; height: 49px; padding-top: 12px; top: 4px; }
...
@media screen and (min-width: 768px) { .navbar-right { margin-right: 0; }
...
@media screen and (max-width: 767px) { .navbar .nav > li > a { padding-top: 12px; padding-bottom: 10px; }
...
@media (max-width: 420px) { .navbar .container .navbar-header .navbar-brand { padding: 14px 0 14px; width: 160px; overflow: hidden; }
  .navbar .container .navbar-header .navbar-brand img { width: 100%; max-width: none; }
...
@media (max-width: 310px) { .navbar .container .navbar-header .navbar-brand { width: 120px; } }
.main-footer { background: #fff; padding-bottom: 32px; padding-top: 60px; border-top: solid 1px #DDD; }
...
.panel-group .panel, .panel-default, .list-group { border: solid 1px #DDD; border-radius: 10px; box-shadow: none; color: #333333; display: block; text-decoration: none !important; }
...
@media (max-width: 768px) { .panels-row { display: block; } }
/*TOGGLE DNI*/
...
.jumbotron .dropdown-menu li a:not(.btn):hover, .jumbotron .dropdown-menu li a:not(.btn):focus { color: #fff; }
...
label { font-weight: 600; color: #707070 !important; margin-bottom: 10px !important; font-size: 14px !important; }
...
.form-control { color: #333333; font-size: 16px; height: 44px; padding: 6px 8px; border: solid 1px #DDD; border-radius: 10px; box-shadow: none .form-control [disabled], .form-control [readonly]; box-shadow-background-color: #f2f2f2; }
...
.inputfile + label { background-color: #ececec; border: 2px solid #e0e2e2; display: inline-block; font-weight: 700; padding: 4px 15px; transition: .3s ease-in-out; }
