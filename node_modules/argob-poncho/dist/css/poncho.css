...
@media (max-width: 767px) { .panels-row { display: block; }
  .icon-fix { min-height: 116px !important; }
...
.form-control { color: #333333; font-size: 16px; height: 44px; padding: 6px 16px; border: solid 1px #DDD; border-radius: 10px; box-shadow: none; }
