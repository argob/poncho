...
.panel-border-naranja {margin-bottom: 0;border-color: #ddd;border-bottom: 12px solid #2cb9ee;}

.panel-border-fucsia {border-color: #ddd;border-bottom: 12px solid #f79525;}

.panel-border-lila {border-color: #ddd;border-bottom: 12px solid #ed3d8f;}
