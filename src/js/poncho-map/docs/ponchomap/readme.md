...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left"><code>object</code></td>
      <td style="text-align:left"><code>{}</code></td>
      <td style="text-align:left"><p>Define un ícono personalizado para cada encabezado de la entrada.</p><p><a href="header-icons/README.md">Ver opciones para header_icons</a>.</p></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left"><p>Permite asignar un color específico a los marcadores o definir una función personalizada para controlar los colores o tipos de iconos.</p><p><a href="marker/README.md">Ver opciones para marker</a>.</p></td>
    </tr>
    <tr>
...
<pre><code>summary: {
    ...
    position: "top|bottom"
      ...
      <p><a href="summary/README.md">Ver opciones para <em>summary</em></a>.</p>
      </td>
    </tr>
    <tr>
      ...
      <td style="text-align:left"><p>Define la función que controla el template para el popup o el slider.</p><p><a href="template/README.md">Ver opciones para template</a>.</p></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left"><code>object</code></td>
      <td style="text-align:left"><code>{}</code></td>
      <td style="text-align:left"><p>Define el listado de valores a mostrar en el template por defecto o excluye valores que no se deseen mostrar.</p><p><a href="template-structure/README.md">Ver opciones para template_structure</a>.</p></td>
    </tr>
    <tr>
