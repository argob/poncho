...
|:---|:---|:---|:---|:---|
| template | string |  | Define una plantilla HTML con claves encerradas en doble llave. Por ejemplo: `"{{valor}} <strong>{{porcentaje}} %</strong>"`, donde `valor` y `porcentaje` representan propiedades del objeto de datos. Ver [condicional en línea](../../ponchomap/condicional-en-linea/readme.md) | *Opcional* |
